      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-3 mb-12 lg:mb-0 pr-4">
            <h2 className="text-3xl font-bold text-white mb-4 leading-tight">Crafted with excellent material.</h2>
            <p className="text-white mb-6 text-sm leading-relaxed">Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate velit imperdiet dolor tempor tristique.</p>
          ...
          <div className="lg:col-span-9 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group relative text-center pt-10 pb-8 px-4 cursor-pointer z-10">
              <div className="absolute bottom-0 left-0 w-full bg-amber-600 rounded-3xl h-0 group-hover:h-[75%] transition-all duration-300 -z-10"></div>
              <a className="block" href="/cart">
                ...
                <h3 className="text-white font-semibold text-base mb-1">Lavadora de alta pressão <br /> WAP Líder 2200</h3>
                <strong className="text-white font-bold text-lg">R$ 618,99</strong>
              </a>
            </div> 
            {/* Produto 2 */}
            <div className="group relative text-center pt-10 pb-8 px-4 cursor-pointer z-10">
              ...
              <a className="block" href="/cart">
                ...
                <h3 className="text-white font-semibold text-base mb-1">Parafusadeira Furadeira de<br /> Impacto Brushless</h3>
                <strong className="text-white font-bold text-lg">R$ 1449,99</strong>
              </a>
            </div>
            {/* Produto 3 */}
            <div className="group relative text-center pt-10 pb-8 px-4 cursor-pointer z-10">
              ...
              <a className="block" href="/cart">
                ...
                <h3 className="text-white font-semibold text-base mb-1">Jogo de Ferramentas<br />com 216 Pecas e Maleta</h3>
                <strong className="text-white font-bold text-lg">R$ 1.149,99</strong>
              </a>
            </div>
            {/* Produto 4 */}
            <div className="group relative text-center pt-10 pb-8 px-4 cursor-pointer z-10">
              ...
              <a className="block" href="/cart">
                ...
                <h3 className="text-white font-semibold text-base mb-1">Motosserra a Gasolina<br /> 63CC 3HP</h3>
                <strong className="text-white font-bold text-lg">R$ 649,99</strong>
              </a>
            </div>
            {/* Produto 5 */}
            <div className="group relative text-center pt-10 pb-8 px-4 cursor-pointer z-10">
              ...
              <a className="block" href="/cart">
                ...
                <h3 className="text-white font-semibold text-base mb-1">Aparador de Grama 1500W<br />GARTHEN-GAM1500BP</h3>
                <strong className="text-white font-bold text-lg">R$ 319,99</strong>
              </a>
            </div>
            {/* Produto 6 */}
            <div className="group relative text-center pt-10 pb-8 px-4 cursor-pointer z-10">
              ...
              <a className="block" href="/cart">
                ...
                <h3 className="text-white font-semibold text-base mb-1">Machadinha com Cabo de Fibra<br />VONDER-3589000600</h3>
                <strong className="text-white font-bold text-lg">R$ 94,29</strong>
              </a>
            </div>
            {/* Produto 7 */}
            <div className="group relative text-center pt-10 pb-8 px-4 cursor-pointer z-10">
              ...
              <a className="block" href="/cart">
                ...
                <h3 className="text-white font-semibold text-base mb-1">Trator Cortador de Grama<br /> BT 1942 a Gasolina </h3>
                <strong className="text-white font-bold text-lg">R$ 26.899,99</strong>
              </a>
            </div>
            {/* Produto 8 */}
            <div className="group relative text-center pt-10 pb-8 px-4 cursor-pointer z-10">
              ...
              <a className="block" href="/cart">
                ...
                <h3 className="text-white font-semibold text-base mb-1">Carro para Ferramentas com 11 Gavetas <br />SATA-ST95114G-B</h3>
                <strong className="text-white font-bold text-lg">R$ 7.399,99</strong>
              </a>
            </div>
            {/* Produto 9 */}
            <div className="group relative text-center pt-10 pb-8 px-4 cursor-pointer z-10">
              ...
              <a className="block" href="/cart">
                ...
                <h3 className="text-white font-semibold text-base mb-1">Soprador Aspirador 800W 220V<br />DEWALT-DWB800</h3>
                <strong className="text-white font-bold text-lg">R$ 849,99</strong>
              </a>
            </div>
          </div>
        </div>
