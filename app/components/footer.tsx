        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
          ...
          <div className="lg:col-span-8">
            ...
            <form className="flex flex-col sm:flex-row gap-4">
              ...
              <input type="text" className="border border-gray-300 rounded-lg px-4 py-3 flex-1 focus:outline-none focus:border-[#ea580c]" placeholder="Escreva seu nome" />
              <input type="email" className="border border-gray-300 rounded-lg px-4 py-3 flex-1 focus:outline-none focus:border-[#ea580c]" placeholder="Escreva seu email" />
          ...
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-8 text-sm text-gray-500">
            <ul>
              ...
              <li className="mb-2"><a href="#" className="hover:text-[#ea580c] transition">Clientes</a></li>
               <li className="mb-2"><a href="#" className="hover:text-[#ea580c] transition">Supporte</a></li>
            </ul>
            <ul>
