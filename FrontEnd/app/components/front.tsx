        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-5 z-10 text-center lg:text-left">
            ...
            <div className="flex justify-center lg:justify-start space-x-4">
              ...
              <a href="#produto" className="border-2 scroll-behavior: smooth; border-white/30 text-white font-semibold px-8 py-3.5 rounded-full hover:border-white hover:bg-white/10 transition duration-300">explore mais</a>
            </div>
          </div>
